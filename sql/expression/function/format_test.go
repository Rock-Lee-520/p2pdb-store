...
func TestFormat(t *testing.T) {
	testCases := []struct {
		...
		{"float64 with blob d", sql.Float64, sql.Blob, sql.NewRow(5555.855, []byte{1, 2, 3}, nil), nil, nil},
		...
		{"text float with blob d", sql.Text, sql.Blob, sql.NewRow("98765432.1234", []byte{1, 2, 3}, nil), nil, nil},
